...
No se que diablos haga si le mueve y explota es su problema 

## Creditos

Desarrollado con Python, [pydualsense](https://github.com/flok/pydualsense) y [CustomTkinter](https://github.com/TomSchimansky/CustomTkinter).
